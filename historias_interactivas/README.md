...
| 6 | **Tecnología** | "El Algoritmo Invisible" | Diego Morales (CTO startup) | 6/6 ✅ |
| 7 | **Turismo** | "El Check-in Inesperado" | Carolina Pérez (Gerente hotelera) | 6/6 ✅ |
| 8 | **Agricultura** | "El Surco Perdido" | Roberto Méndez (Gerente cooperativa) | 6/6 ✅ |
| 9 | **Energía** | "El Vatio Inesperado" | Luis "Lucho" Ferrada (Subgerente EnerSur) | 6/6 ✅ |
| 10 | **Transporte** | "El Viaje Inesperado" | Felipe Santander (Gerente transporte) | 6/6 ✅ |

**Total completado: 10/10 industrias (100%)**
...
**Protagonista:** Dra. Ana Morales, Clínica SaludTotal (3 sedes en Santiago).
...
**Resumen:** Roberto enfrenta brecha de historial crediticio. Notifica en 4h, reduce multa de 1.000 a 350 UTM con atenuantes.
...
**Resumen:** Andrés enfrenta falla de sistema biométrico. Notifica en 3h, cifra dispositivos, implementa DPO, obtiene Sello APDP-MINTRAB.
**Artículos cubiertos:** Art. 5-9, 12, 14, 14 quinquies, 14 sexies, 16 bis, 16 ter, 28, 50

### 6. Tecnología - "El Algoritmo Invisible"
...
### 8. Agricultura - "El Surco Perdido"
...
### 9. Energía - "El Vatio Inesperado"
**Protagonista:** Luis Ignacio "Lucho" Ferrada, Subgerente Tecnología EnerSur (1.2M clientes, 600K smart meters).
**Resumen:** Lucho descubre que EnerSur comparte perfiles de consumo con marketing sin consentimiento. Breach de 80.000 clientes por consultor subcontratado. Implementa cifrado, DPO, RAT.
**Artículos cubiertos:** Art. 14, 14 quinquies, 14 sexies, 15 ter, 16, 16 bis, 35, 49, 50

### 10. Transporte - "El Viaje Inesperado"
...
- **4 prompts de imagen** (Midjourney v6.0 / DALL-E 3)
- **2 prompts de video** (fal.ai Minimax H3 Max Turbo, 15s)

**Total:** 40 prompts de imagen + 20 prompts de video

**Regla obligatoria:** Todo texto en pantalla en español y audio en español latino (NO peninsular).
...
### 1. Simulador ARCO
Guía paso a paso para ejercer derechos de Acceso, Rectificación, Cancelación, Oposición.

### 2. Árbol de Decisiones
Guía para actuar ante brechas de seguridad y eventos críticos.

### 3. Quiz (7 preguntas)
Evaluación formativa con preguntas de elección múltiple y fundamentación legal.
...
## 🏗️ Pipeline de Producción (Versión 2.0)

Desde septiembre 2026, las historias se producen con un **pipeline multiagente** definido en `/opt/data/ley21719-cl/.hermes/AGENTS.md`:

- **Filial 2** (contenido creativo) + **Filial 3** (contenido legal) coordinadas
- Roles especializados: Lore Keeper Legal, Guionista, Director de Arte, Maquetador, Editor de Continuidad, Integrador
- Regla de validación: cada cita legal verificable en BCN LeyChile idNorma=1209272
...
*Duración total estimada de narración: ~65 minutos por historia (10 horas total)*
